...
/**
 * copy from <a href="https://github.com/yomorun/hashids-java">hashids</a>
 */
public class HashidsTest {
    ...
    public void test_large_number_not_supported() {
        final long num_to_hash = 9007199254740993L - 1;
        final Hashids a = new Hashids("this is my salt");
        String encode = a.encode(num_to_hash);
    ...
    public void test_wrong_decoding() {
        ...
        final long[] b1 = a.decode("262mm1m4J9Z");
    ...
    public void test_serveral_numbers() {
        ...
        Assert.assertArrayEquals(res2, num_to_hash);
    }
    ...
    public void a() {
        ...
        System.out.println(hashids.decode("NV")[0]);

        boolean negative = Duration.between(Instant.now().minusSeconds(1), Instant.now()).isNegative();
