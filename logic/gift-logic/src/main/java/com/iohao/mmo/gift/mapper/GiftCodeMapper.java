...
public interface GiftCodeMapper {
    GiftCodeMapper ME = Mappers.getMapper(GiftCodeMapper.class);

    GiftCodeMessage convert(GiftCode giftCode);

    GiftCode convert(GiftCodeMessage giftCodeMessage);

    List<GiftCodeMessage> convertGiftCodeMessages(List<GiftCode> giftCodes);
}
