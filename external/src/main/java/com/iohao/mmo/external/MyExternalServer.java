...
public class MyExternalServer {
    ...
    public ExternalServer createExternalServer(int externalPort) {
        ...
        builder.setting().setIdleProcessSetting(new IdleProcessSetting().setIdleTime(300).setPong(true));
...
//        });
    ...
    private static void extractedAccess() {
        ...
        // These routes grant or replace data on behalf of other logic servers.
        accessAuthenticationHook.addRejectionCmd(BagCmd.cmd, BagCmd.incrementItem);
        accessAuthenticationHook.addRejectionCmd(BagCmd.cmd, BagCmd.decrementItem);
        accessAuthenticationHook.addRejectionCmd(LevelCmd.cmd, LevelCmd.personAddExp);
        accessAuthenticationHook.addRejectionCmd(LevelCmd.cmd, LevelCmd.personUpLevel);
        accessAuthenticationHook.addRejectionCmd(LevelCmd.cmd, LevelCmd.ofLevel);
        accessAuthenticationHook.addRejectionCmd(PersonCmd.cmd, PersonCmd.initPerson);
        accessAuthenticationHook.addRejectionCmd(EquipCmd.cmd, EquipCmd.randomEquip);
        accessAuthenticationHook.addRejectionCmd(EquipCmd.cmd, EquipCmd.createEquip);
        accessAuthenticationHook.addRejectionCmd(EquipCmd.cmd, EquipCmd.allotEquip);
        accessAuthenticationHook.addRejectionCmd(EquipCmd.cmd, EquipCmd.resetEquip);
        accessAuthenticationHook.addRejectionCmd(MailCmd.cmd, MailCmd.addMail);
        accessAuthenticationHook.addRejectionCmd(PetCmd.cmd, PetCmd.boomEgg);
        accessAuthenticationHook.addRejectionCmd(PetCmd.cmd, PetCmd.createPet);
    }
