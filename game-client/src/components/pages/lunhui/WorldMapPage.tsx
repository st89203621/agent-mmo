...
import { getVisualContext, type VisualAssetSpec } from '../../../data/visualAssets';
...
export default function WorldMapPage() {
  ...
  usePageBackground(useMemo<VisualAssetSpec>(() => ({
    assetKey: 'world_map_overview',
    type: 'scene',
    name: '世界地图',
    description: '广阔的世界地图，山川河流交织，各大城镇闪烁着灯火，俯瞰视角，云雾环绕。',
